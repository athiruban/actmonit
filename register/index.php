			        ...
			        <select name="sskill">
                        ...
                        <div class="row">
                            <div class="large-6 columns">
                                <a href="#" class="small radius button" onClick="buttonClicked('regsavebutton')">Save</a>
			    </div>
                            <div class="large-6 columns">
                                <a href="#" class="small radius button" onClick="buttonClicked('regcanbutton')">Cancel</a>
			    </div>
		        </div>
      	        ...
      	        <div class="panel">
                    <div class="row">
                        <div class="large-12 medium-12 columns">
                            <center> Please fill the details to        
                            </center>
			</div>
                    </div>
                    <div class="row">
                        <div class="large-12 medium-12 columns">
                            <center> <img src="../img/badge_join_us.png" />       
                            </center>
			</div>
                    </div>
                    <div class="row">
                        <div class="large-12 medium-12 columns">
                            <center> <img src="../img/join-team-icons.png" />       
                            </center>
			</div>
                    </div>
 	        </div>
